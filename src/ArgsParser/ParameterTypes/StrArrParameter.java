...
public class StrArrParameter extends Parameter<String[]> {
    ...
    /**
     * Constructs a new {@link Parameter} of type {@link String}-Array instance with the specified flags, description, and mandatory status.
     * <p>
     ...
     */
    public StrArrParameter(String fullFlag, String shortFlag, String description, boolean isMandatory) {
        super(fullFlag, shortFlag, description, isMandatory, String[].class);
    }

    /**
     * Constructs a new {@link Parameter} of type {@link String}-Array instance with the specified flags, description, and a default value.
     * <p>
     * The constructor validates and formats the provided flag names.
     * </p>
     *
